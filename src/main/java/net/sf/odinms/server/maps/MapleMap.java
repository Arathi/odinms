...
import net.sf.odinms.server.life.Spawns;
import net.sf.odinms.server.life.SpawnPoint;
import net.sf.odinms.server.life.SpawnPointAreaBoss;
import net.sf.odinms.server.life.MonsterDropEntry;
import net.sf.odinms.server.life.MonsterGlobalDropEntry;
...
//            chr.dropMessage(5, "Use @joyce to collect your Item Of Appreciation once you're level 10! Use @help for commands. Good luck and have fun!");
    ...
    public final boolean makeCarnivalSpawn(final int team, final MapleMonster newMons, final int num) {
        ...
        for (MapleNodes.MonsterPoint mp : nodes.getMonsterPoints()) {
