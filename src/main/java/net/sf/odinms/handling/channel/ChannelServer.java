...
import net.sf.odinms.KinMS.db.AutoCherryMSEventManager;
...
import net.sf.odinms.server.events.MapleCoconut;
import net.sf.odinms.server.events.MapleEvent;
import net.sf.odinms.server.events.MapleEventType;
import net.sf.odinms.server.events.MapleFitness;
import net.sf.odinms.server.events.MapleOla;
import net.sf.odinms.server.events.MapleOxQuiz;
import net.sf.odinms.server.events.MapleSnowball;
