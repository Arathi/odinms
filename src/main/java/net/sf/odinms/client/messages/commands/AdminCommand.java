...
import net.sf.odinms.client.inventory.MapleInventoryIdentifier;
...
import net.sf.odinms.handling.login.handler.AutoRegister;
...
import net.sf.odinms.handling.world.family.MapleFamily;
...
import net.sf.odinms.tools.packet.MobPacket;
...
import net.sf.odinms.server.life.PlayerNPC;
...
import net.sf.odinms.tools.CPUSampler;
...
import net.sf.odinms.server.events.MapleOxQuizFactory;
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            if (GameConstants.isPet(itemId)) {
                ...
                if (GameConstants.getInventoryType(itemId) == MapleInventoryType.EQUIP) {
                    ...
                    item = new net.sf.odinms.client.inventory.Item(itemId, (byte) 0, quantity, (byte) 0);
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            for (Integer i : chars) {
                if (i == -1) {
                    ...
                    net.sf.odinms.client.inventory.Item item = new net.sf.odinms.client.inventory.Item(val, (byte) 0, (short) 1);
...
//    }
    ...
    public static class StartProfiling extends CommandExecute {
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            sampler.addIncluded("net/sf/odinms/client");
            sampler.addIncluded("net/sf/odinms/constants"); //or should we do Packages.constants etc.?
            sampler.addIncluded("net/sf/odinms/database");
            sampler.addIncluded("net/sf/odinms/handling");
            sampler.addIncluded("net/sf/odinms/provider");
            sampler.addIncluded("net/sf/odinms/scripting");
            sampler.addIncluded("net/sf/odinms/server");
            sampler.addIncluded("net/sf/odinms/tools");
            sampler.start();
            return 1;
        }
        ...
        public int execute(MapleClient c, String splitted[]) {
            ...
            if (GameConstants.isPet(itemId)) {
                ...
                if (GameConstants.getInventoryType(itemId) == MapleInventoryType.EQUIP) {
                    ...
                    toDrop = new net.sf.odinms.client.inventory.Item(itemId, (byte) 0, (short) quantity, (byte) 0);
                }
